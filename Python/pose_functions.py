...
Hard targets- set targets for the motor
soft targets- locations offset from current motor location
delays
differentiating between each motors
0-180 degrees
which motor is moving and by how much
...
check_pose() # loop runs until manually broken out of
